...
__DEFINE__(1652503089778, function(require, module, exports) {
module.exports = {
  HYEventBus: require('./event-bus'),
  HYEventStore: require('./event-store')
}

}, function(modId) {var map = {"./event-bus":1652503089779,"./event-store":1652503089780}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1652503089779, function(require, module, exports) {
class HYEventBus {
  constructor() {
    this.eventBus = {}
  }
...
__DEFINE__(1652503089780, function(require, module, exports) {
...
}, function(modId) { var map = {"./event-bus":1652503089779,"./utils":1652503089781}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1652503089781, function(require, module, exports) {
...
return __REQUIRE__(1652503089778);
})()
